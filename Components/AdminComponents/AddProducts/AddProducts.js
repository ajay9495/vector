...
export default function AddProducts() {
  ...
  const {ProductData, Events, ToastState, toggleToastState, closeToast, RequestStatus} = AddProductsLogic();
        ...
        <Box  globalStyles={'bo p-5'} localStyles={styles.content} >
          ...
          <Col globalStyles={'bo w-fit px-5 py-5 g-4'} localStyles={styles.contentSub}>
            ...
            <Box  globalStyles={'bo w-12'}  >
              <input name="product_name" onChange={Events.changeProductData} type="text" placeholder="Product Name" className={styles.inputs} />
